...
export default class GameScene extends Phaser.Scene {
	...
	update() {
		...
		if(this.ball.onRightPaddle){
			this.ball.body.velocity.y = ((Math.random() * 50) + this.rightPaddle.body.velocity.y);
	...
	ballCollision(){
		this.ball.onRightPaddle = false;
		this.physics.collide(this.rightPaddle, this.ball, function(){this.ball.onRightPaddle = true;}, null, this);
	}
}
